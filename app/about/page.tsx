...
const About = () => {
    return (
        <div>
            ...
            <p>Now, armed with a diverse toolkit of skills and a genuine passion for making a difference, I&apos;m eager to bring my expertise to the forefront. I&apos;m excited about the prospect of joining a company where I can continue to expand my knowledge, learn new languages, and collaborate on projects that have a meaningful impact on people&apos;s lives.</p>
            <p>Thank you for taking the time to visit—I&apos;m eagerly looking forward to the opportunity to connect and explore how we can create something incredible together.</p>
        </div>
    )
}
